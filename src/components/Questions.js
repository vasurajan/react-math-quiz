...
class Questions extends Component {
    ...
    render() {
        ...
        return (
            <div id="quiz" className="quiz--box">
                <h2 className="text-center font-weight-normal quiz--name">{this.props.quiz.name}</h2>
                ...
                <div className="text-center quiz--btn">

                    {this.props.pager.index === 0 ? "" : this.props.quiz.config.allowBack && <button id="first" className="btn btn-default" onClick={this.props.move}>First</button>}
                    {this.props.pager.index === 0 ? "" : this.props.quiz.config.allowBack && <button id="prev" className="btn btn-default" onClick={this.props.move}>Prev</button>}
                    
                    { this.props.pager.index+1 < this.props.pager.count ? <button id="next" className="btn btn-primary btn-gradient gradient3" onClick={this.props.move}>Next </button> : <span></span>}
                    

                    { this.props.pager.index+1 < this.props.pager.count ? <button id="last" className="btn btn-default" onClick={this.props.move}>Last</button> : <span></span>}
                </div>
            </div >
        )
    }
